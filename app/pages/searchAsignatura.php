...
<head>
    ...
    <!--MiScript-->
    <script src="../js/searchAsignatura.js"></script>
    <!--Autoinit-->
    <script>
            ...
            <div class="col s8">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title black-text center">Buscar Asignatura</span>
                        <div class="row">
                            <form class="col s12">
                            ...
                            <div class="col s12">
                                <a class="btn modal-trigger right" href="#modal1" id="buscarAsignatura">BUSCAR</a>
